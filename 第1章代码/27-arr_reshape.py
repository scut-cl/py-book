...
print("轴0添加结果:\n",np.append(ar_app1,[[10,12,14,16],[21,22,23,24]],axis=0))
print("轴1添加结果:\n",np.append(ar_app1,[[10,12,14,16],[21,22,23,24]],axis=1))
#⑧插入元素
ar_ins=np.array([[1,2,3],[5,6,7]])
print("np.insert(ar_ins,(1,2),13):\n",np.insert(ar_ins,[1,2],13))#在原数组位置1,2前面插入13
...
print("np.delete(arr_Del,[3,4]):",np.delete(arr_Del,[3,4]))#一维折叠后删除序号3,4的元素
print("np.delete(arr_Del,1,0):\n",np.delete(arr_Del,1,0))#沿0轴删除序号1的元素
print("np.delete(arr_Del,[2,3],1):\n",np.delete(arr_Del,[2,3],1))#沿1轴删除序号2,3的元素
print("np.delete(arr_Del,np.s_[::2],1):\n",np.delete(arr_Del,np.s_[::2],1))#沿1轴删除序号0,2,4的元素
